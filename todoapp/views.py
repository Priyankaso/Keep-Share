...
from .forms import SignupForm,UserProfileForm,ToDoListForm

from .models import UserProfile,ToDoList,ToDoPoints,City,Connects,ToDoAccess

from django.contrib.auth.models import User

from .utils import reCaptcha,verifyEmail
...
def account_activation_view(request):
	...
	print(uid,actcode,activation_code)
...
def profile_view(request):
	if request.method=='POST':
		...
		return render(request, 'todoapp/profile.html', {'form':form,'uf':uf})
	else:
